...
resmat, method_names, method_times = sms.linear_regression_experiment_matrix_results2(10, 1000, noisy_props, alt_src_strengths)
#resmat = sms.linear_regression_experiment_matrix_results(10, 1000, noise_strengths, alt_src_strengths)
joblib.dump((resmat, method_names, method_times, noisy_props, alt_src_strengths), "linear_results.jl", compress=3)


# <codecell>

(resmat, method_names, method_times, noisy_props, alt_src_strengths) = joblib.load("linear_results.jl")
